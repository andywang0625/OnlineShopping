...
/***/ "./resources/js/components/Create.tsx":
/*!********************************************!*\
  !*** ./resources/js/components/Create.tsx ***!
  \********************************************/
...
class Create extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    constructor(props) {
        ...
        this.handleSubmit = (e) => {
            ...
            axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("api/create", {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null,
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Dialog"], { open: this.state.logdia, onClose: this.handleClose, "aria-labelledby": "dtitle" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["DialogTitle"], { id: "dtitle" }, "Create Post"),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["DialogContent"], null,
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["DialogContentText"], null,
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["DialogActions"], null,
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Button"], { autoFocus: true, onClick: this.handleClose, color: "primary" }, "Got it"))),
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("form", { autoComplete: "off", onSubmit: this.handleSubmit },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { container: true, spacing: 3 },
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { item: true, xs: 12, md: 8 },
                        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TextField"], { variant: "outlined", value: this.state.Title, onChange: this.handleChange("title"), id: "title", label: "Title", className: [classes.titleBar, classes.inputfield].join(" "), color: "secondary", required: true })),
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { item: true, xs: 6, md: 2 },
                        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TextField"], { id: "quantity", label: "Quantity", type: "number", value: this.state.amount, onChange: this.handleChange("amount"), className: classes.inputfield, required: true })),
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { item: true, xs: 6, md: 2 },
                        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TextField"], { id: "price", label: "Price", value: this.state.priceBox, className: classes.inputfield, onChange: this.handleChange("number"), type: "number", InputProps: {
                                startAdornment: (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["InputAdornment"], { position: "start" }, "$"))
                            }, required: true })),
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { item: true, xs: 12 },
                        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Divider"], null)),
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { item: true, xs: 12 },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { item: true, xs: 12 },
                        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { container: true, justify: "flex-end" },
                            react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { item: true, xs: 12, md: 1 },
                                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Button"], { className: [classes.submitbtn, classes.inputfield].join(" "), type: "submit", variant: "contained", color: "primary" }, "Post"))))))));
    }
}
/* harmony default export */ __webpack_exports__["default"] = (Object(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["withStyles"])(styles)(Create));


/***/ }),

/***/ "./resources/js/components/CreateStepper.tsx":
/*!***************************************************!*\
  !*** ./resources/js/components/CreateStepper.tsx ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Create__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Create */ "./resources/js/components/Create.tsx");
...
/* harmony import */ var _UploadImage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./UploadImage */ "./resources/js/components/UploadImage.tsx");
...
function VerticalLinearStepper(props) {
    ...
    function getStepContent(step, token) {
        switch (step) {
            case 0:
                return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Create__WEBPACK_IMPORTED_MODULE_9__["default"], { token: token, postback: handleSave });
            case 1:
                if (postId == "") {
                    return null;
                }
                else {
                    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_UploadImage__WEBPACK_IMPORTED_MODULE_13__["default"], { token: token, postid: postId });
                }
            case 2:
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: classes.root },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_11__["Snackbar"], { className: classes.sb, anchorOrigin: {
                vertical: 'bottom',
                horizontal: 'left',
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_11__["IconButton"], { size: "small", "aria-label": "close", color: "inherit", onClick: handleSnackbarClose },
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_icons_Close__WEBPACK_IMPORTED_MODULE_12___default.a, { fontSize: "small" }))) }),
        msgBox ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_MessageBox__WEBPACK_IMPORTED_MODULE_10__["default"], { callback: closeMesBox, messageType: "e", messageText: "You must finish step one first." }) : null,
...
/***/ "./resources/js/components/UploadImage.tsx":
/*!*************************************************!*\
  !*** ./resources/js/components/UploadImage.tsx ***!
  \*************************************************/
/*! exports provided: default */
...
class UploadImage extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    constructor(props) {
        super(props);
        this.closeMsg = () => {
            this.setState({
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["withStyles"])(({ spacing, palette }) => Object(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["createStyles"])({
    root: {
        marginTop: spacing(4),
    },
    imgListRoot: {},
