...
/* harmony import */ var _material_ui_icons_LockRounded__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @material-ui/icons/LockRounded */ "./node_modules/@material-ui/icons/LockRounded.js");
/* harmony import */ var _material_ui_icons_LockRounded__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_material_ui_icons_LockRounded__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _FormErrorMessage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./FormErrorMessage */ "./resources/js/components/FormErrorMessage.tsx");
...
class Login extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    handleSubmit(e) {
        ...
        if (this.state.userPasswd) {
            ...
            axios__WEBPACK_IMPORTED_MODULE_5___default.a.post("api/login_request", {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Container"], { maxWidth: "md" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Dialog"], { open: this.state.logdia, onClose: this.handleClose, "aria-labelledby": "dtitle" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["DialogTitle"], { id: "dtitle" }, "Registration"),
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], { container: true, direction: "column", justify: "center", alignItems: "center" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Paper"], { className: classes.paper },
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { style: { width: "100%" } },
                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", { onSubmit: this.handleSubmit },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TextField"], { className: classes.margin, id: "userPasswd", name: "userPasswd", type: "password", placeholder: "Password", label: "Password", value: this.state.userPasswd, onChange: this.handleChange, InputProps: {
                                        startAdornment: (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["InputAdornment"], { position: "start" },
                                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_icons_LockRounded__WEBPACK_IMPORTED_MODULE_3___default.a, null)))
                                    }, required: true }),
                                this.state.errorMessage !== undefined ? (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_FormErrorMessage__WEBPACK_IMPORTED_MODULE_4__["default"], { theMessage: this.state.errorMessage })) : null,
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Button"], { className: classes.submitbtn, type: "submit", variant: "contained", color: "primary" }, "Login"))))))));
    }
}
